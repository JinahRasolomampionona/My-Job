...
<head>
    ...
    <!-- CSS -->
    @vite(['resources/css/app.css', 'resources/css/plugins.min.css'])
    @vite(['resources/css/demo.css', 'resources/css/kaiadmin.min.css', 'resources/css/global.css', 'resources/css/responsive.css'])
</head>
    ...
    <div class="wrapper">
        ...
        <div class="main-panel">
            <div class="main-header">
                ...
                <!-- Navbar Header -->
                <nav class="navbar navbar-header bg-white navbar-expand-lg border-bottom">
                        ...
                        <ul class="navbar-nav topbar-nav ms-md-auto align-items-center">
                                    ...
                                    <li>
                                        <div class="message-notif-scroll scrollbar-outer">
                                            <div class="notif-center">
                                                <a href="#">
                                                    <div class="notif-img">
                                                        <img src="{{ Vite::asset('resources/images/im1.jpg') }}" alt="Img Profile" />
                                                    </div>
                            ...
                            <li class="nav-item topbar-user dropdown hidden-caret">
                                <a class="dropdown-toggle profile-pic" data-bs-toggle="dropdown" href="#"
                                    aria-expanded="false">
                                    <div class="avatar-sm">
                                        <img src="{{ Vite::asset('resources/images/im1.jpg') }}" alt="..." class="avatar-img rounded-circle" />
                                    </div>
                                ...
                                <ul class="dropdown-menu dropdown-user animated fadeIn">
                                    <div class="dropdown-user-scroll scrollbar-outer">
                                        <li>
                                            <div class="user-box">
                                                <div class="avatar-lg">
                                                    <img src="{{ Vite::asset('resources/images/im1.jpg') }}" alt="image profile"
                            ...
                            <li class="form-logout">
                                <form method="POST" action="{{ route('logout') }}" class="d-flex justify-content-center mr-2">
                                    @csrf
                                    <button type="submit" class="icon-logout"><i class="fa-solid fa-right-from-bracket"></i></button>
                                </form>
                            </li>
                        </ul>
                    </div>

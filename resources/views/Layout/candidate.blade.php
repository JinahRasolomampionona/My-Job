...
<body>
    <div class="sidebar" id="sidebar">
        ...
        <a href="{{ route('candidates.candidate') }}" class="page">
            <i class="fas fa-home me-2"></i>Page Candidat<i class="fas fa-chevron-right i-page"></i>
        </a>

        <a href="{{ route('candidates.profils.profil') }}"
            class="{{ Route::currentRouteName() == 'candidates.profils.profil' ? 'active' : '' }}">
            <i class="fas fa-layer-group me-2"></i>Créer un profil
        </a>

        <a href="{{ route('candidates.offers.index') }}"
            class="{{ Route::currentRouteName() == 'candidates.offers.index' ? 'active' : '' }}">
            <i class="fas fa-users me-2"></i>Voir les offres d'emploi
        </a>
